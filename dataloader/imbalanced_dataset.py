...
class ImTestloader(torch.utils.data.Dataset):
    def __init__(self, data_path, **kwargs):
        super(ImTestloader, self).__init__()
        self.main_path = data_path
...
# a = ImTestloader(data_path=r'D:\cifar10\cifar10_imbalance')
# a.load_meta()
